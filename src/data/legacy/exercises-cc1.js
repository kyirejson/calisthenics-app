...
const exercisesCC1 = [
  ...
  },
  {
    ...
    "purpose": "《囚徒健身2》终极小腿专项：打造钻石般强壮的小腿腓肠肌、比目鱼肌与防弹跟腱，强化下肢爆发移动与踝关节抗扭能力，彻底告别足踝伤痛",
    "keyPoints": [
      "站位与平衡：单脚前脚掌（赤脚或薄底鞋最佳）稳固踩在台阶边缘，双手轻扶墙壁或栏杆维持平衡；非发力腿屈膝悬空，脚背轻搭于发力腿脚踝后方",
      "直腿绝对锁死：发力腿膝关节必须绝对伸直（初阶可微屈），锁死膝盖，将全部自重张力施加在跨膝踝双关节的腓肠肌上，严禁屈膝偷力",
      "2-1-2-1 慢速节奏：用 2 秒平稳抬起脚后跟至极限最高点，顶峰收缩停顿 1 秒；再用 2 秒缓慢受控下沉脚后跟至台阶以下最大拉伸位",
      "消除反弹力矩：在动作最低点必须强制停顿 1 秒完全消除肌腱回弹力，完全依靠纯肌肉力量启动下一次升起，全程匀速，严禁快速弹跳借力",
      "组间核心拉伸：单腿完成一组后，不要离开台阶，脚跟下沉到底部施加自重静态下压拉伸 60 秒（20次深呼吸），再换另一条腿练习与拉伸"
    ],
    "commonIssues": [
      {
        "problem": "在最低点借力反弹",
        "fix": "原著铁律：必须在动作底部停顿1秒消除反弹力，纯靠肌肉匀速慢起慢落，严禁弹震偷懒"
      },
      {
        "problem": "后半程屈膝借力",
        "fix": "膝关节必须保持绝对锁死伸直；屈膝会使负荷滑向单关节比目鱼肌，失去终极直腿刺激"
      },
      {
        "problem": "组间直接休息未拉伸",
        "fix": "单腿做完一组必须立即在台阶最低点下压拉伸60秒，不仅预防抽筋，更能建立跟腱强大张力柔韧性"
      }
    ],
    "standards": {
      "beginner": "阶段7(屈腿打底) 2组 × 15次",
      "intermediate": "阶段8(直腿进阶) 4组 × 30次",
      "upgrade": "阶段8(直腿终极) 4组 × 50次 (大师级，慢速停顿+组间拉伸)"
    },
    "defaultPrescription": {
      "sets": 3,
      "repRange": [
      ...
      "restSeconds": 60,
      "tempoDescription": "2秒起·1秒顶峰收缩·2秒落·1秒底部拉伸停顿",
      "rirTarget": 2
    }
  }
];
